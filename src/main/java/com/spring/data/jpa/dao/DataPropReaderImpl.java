...
import com.spring.data.jpa.Entity.UserPropertyKeys;
...
public class DataPropReaderImpl implements DataPropReader {
    ...
    @Override
    public UserData getUserData(String propertyFilePath) throws IOException {

        UserData userData = new UserData();
        Properties userPropFile;

        if (propertyFilePath.equals("")) {
            userPropFile = readPropertyFile(DataPropReader.propertyFilePath);
        } else {
            userPropFile = readPropertyFile(propertyFilePath);
        }
